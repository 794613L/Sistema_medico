...
export class ListStaffNComponent {
  ...
  // Variables para la gestión de datos de usuarios
  ...
  public totalPages = 0;
   ...
   // Variables para roles y usuario seleccionado
  ...
  // Obtener datos de la tabla inicial
  private getTableData(): void {
    this.usersList = [];
    this.serialNumberArray = [];

    this.staffService.listUsers().subscribe((resp:any) => {
     // Obtener datos de usuarios del servicio
      console.log(resp);
  ...
  deleteUser(){
    ...
    this.staffService.deleteUser(this.staff_selected.id).subscribe((resp:any) => {
      ...
      if(INDEX != -1){
        ...
        // Limpiar modales y estilos adicionales
        $('#delete_patient').hide();
  ...
  // Moverse a una página específica
